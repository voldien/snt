...
#define SNT_ENCRYPTION_AES_ECB128		0x20	/*	Electronic Codebook.	*/
#define SNT_ENCRYPTION_AES_ECB192		0x40	/*	Electronic Codebook.	*/
#define SNT_ENCRYPTION_AES_ECB256		0x80	/*	Electronic Codebook.	*/
#define SNT_ENCRYPTION_AES_CBC128		0x100	/*	Cipher Block Chaining.	*/
#define SNT_ENCRYPTION_AES_CBC192		0x200	/*	Cipher Block Chaining.	*/
#define SNT_ENCRYPTION_AES_CBC256		0x400	/*	Cipher Block Chaining.	*/
#define SNT_ENCRYPTION_AES_CFB128		0x800	/*	Cipher Feedback.	*/
#define SNT_ENCRYPTION_AES_CFB192		0x1000	/*	Cipher Feedback.	*/
#define SNT_ENCRYPTION_AES_CFB256		0x2000	/*	Cipher Feedback.	*/
