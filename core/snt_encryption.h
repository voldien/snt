...
enum SntSymetricCipher {
	SntSymmetricCipherNONE,
	SntSymmetricCipherAES_ECB128,
	SntSymmetricCipherAES_ECB192,
	SntSymmetricCipherAES_ECB256,
	SntSymmetricCipherBLOWFISH,
	SntSymmetricCipherDES,
	SntSymmetricCipher3DES,
	SntSymmetricCipherAES_CBC128,
	SntSymmetricCipherAES_CBC192,
	SntSymmetricCipherAES_CBC256,
	SntSymmetricCipherAES_CFB128,
	SntSymmetricCipherAES_CFB192,
	SntSymmetricCipherAES_CFB256,
	SntSymmetricCipherAES_OFB128,
	SntSymmetricCipherAES_OFB192,
	SntSymmetricCipherAES_OFB256,
	SntSymmetricCipher3DESCBC,
	SntSymmetricCipherBF_CBC,
	SntSymmetricCipherBF_CFB,
	SntSymmetricCipherRC4,
	SntSymmetricCipherCAST,
	SntSymmetricCipherCASTCBC,
	SntSymmetricCipherCASTCFB,
	SntSymmetricCipherSYM_ALL,
};
...
#define SNT_ENCRYPTION_SYM_ALL                                                                                         \
	(SNT_ENCRYPTION_BLOWFISH | SNT_ENCRYPTION_DES | SNT_ENCRYPTION_3DES | SNT_ENCRYPTION_AES_ECB128 |                  \
	 SNT_ENCRYPTION_AES_ECB192 | SNT_ENCRYPTION_AES_ECB256 | SNT_ENCRYPTION_AES_CBC128 | SNT_ENCRYPTION_AES_CBC192 |   \
	 SNT_ENCRYPTION_AES_CBC256 | SNT_ENCRYPTION_AES_CFB128 | SNT_ENCRYPTION_AES_CFB192 | SNT_ENCRYPTION_AES_CFB256)
...
#define SNT_ENCRYPTION_ASYM_ALL (SNT_ENCRYPTION_ASYM_RSA)
 ...
 */
extern int sntASymGenerateKey(SNTConnection *connection, unsigned int cipher, unsigned int numbits);
 ...
 *	@Return none zero if successfully.
 */
extern int sntASymCreateKeyFromData(SNTConnection *SNT_RESTRICT connection, unsigned int cipher,
									const void *SNT_RESTRICT data, int len, unsigned int private);
 ...
 */
extern int sntASymCopyPublicKey(const SNTConnection *SNT_RESTRICT connection, void *SNT_RESTRICT cpkey);
 ...
 */
extern int sntASymCreateKeyFromFile(SNTConnection *SNT_RESTRICT connection, unsigned int cipher,
 ...
 *	@Return non zero if successful.
 */
extern int sntASymCreateFromX509File(SNTConnection *SNT_RESTRICT connection, const char *SNT_RESTRICT cfilepath);
 ...
 */
extern int sntASymPubEncrypt(unsigned int type, const void *SNT_RESTRICT source, unsigned int len,
							 void *SNT_RESTRICT dest, const void *SNT_RESTRICT key);
 ...
 */
extern int sntASymPriDecrypt(unsigned int type, const void *SNT_RESTRICT input, unsigned int len,
							 void *SNT_RESTRICT output, const void *SNT_RESTRICT key);
 ...
 */
extern int sntASymSignDigSign(const SNTConnection *SNT_RESTRICT connection, unsigned int hashtype,
							  const void *SNT_RESTRICT hash, unsigned int len, void *SNT_RESTRICT output,
							  int32_t *SNT_RESTRICT diglen);
 ...
 */
extern int sntASymVerifyDigSign(const SNTConnection *SNT_RESTRICT connection, unsigned int hashtype,
								const void *SNT_RESTRICT hash, unsigned int len, void *SNT_RESTRICT digital,
								unsigned int diglen);
 ...
 *	@Return non zero if successfully.
 */
extern int sntSymCreateFromKey(SNTConnection *SNT_RESTRICT connection, unsigned int cipher,
							   const void *SNT_RESTRICT pkey);
 ...
 *	Remark:
 */
extern void sntSymCopyKey(SNTConnection *SNT_RESTRICT connection, void **SNT_RESTRICT key);
 ...
 *	@Return	number of bytes encrypted.
 */
extern unsigned int sntSymEncrypt(const SNTConnection *SNT_RESTRICT connection, const void *SNT_RESTRICT data,
								  unsigned char *SNT_RESTRICT output, unsigned int len, void *SNT_RESTRICT iv,
								  int *SNT_RESTRICT feedback);
 ...
 *	@Return	number of bytes decrypted.
 */
extern unsigned int sntSymDecrypt(const SNTConnection *SNT_RESTRICT connection, const void *SNT_RESTRICT data,
								  unsigned char *SNT_RESTRICT output, unsigned int len, void *SNT_RESTRICT iv,
								  int *SNT_RESTRICT feedback);
